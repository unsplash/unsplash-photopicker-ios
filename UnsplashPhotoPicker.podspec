Pod::Spec.new do |spec|
  ...
  spec.source           = { :git => 'https://github.com/unsplash/unsplash-photopicker-ios', :tag => 'v1.0.0' }
  spec.source_files     = 'UnsplashPhotoPicker/UnsplashPhotoPicker/Sources/**/*.{h,m,swift,xib,strings,stringsdict}'
